...
from lib.Network_conv import Network
from code.utils.data_val import get_test_loader
import tqdm
...
parser.add_argument('--ration', type=int, default=1, help='ration')
parser.add_argument('--pth_path', type=str, default="../weight/NNet/")  # this
...
with torch.no_grad():
    for _data_name in datasets:
        ...
        #image_root = '{}/gen_depth/'.format(data_path)
